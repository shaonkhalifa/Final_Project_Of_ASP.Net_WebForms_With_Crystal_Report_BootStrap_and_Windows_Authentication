<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportPage.aspx.cs" Inherits="AnimalMarkeManagementSystem.ReportPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="ReportInvoice.rpt">
        </Report>
